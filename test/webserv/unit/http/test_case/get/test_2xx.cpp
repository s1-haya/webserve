...
int TestGetOk4ConnectionKeepAndOkConnectionKeep(const server::VirtualServerAddrList &server_infos) {
	http::ClientInfos client_infos         = CreateClientInfos(request::GET_200_4_CONNECTION_KEEP_AND_200_CONNECTION_KEEP);
	std::string       expected_status_line = EXPECTED_STATUS_LINE_OK;
	std::string       expected_body_message = LoadFileContent("../../../../root/html/index.html");
	HeaderFields      expected_header_fields;
	expected_header_fields[http::CONNECTION]     = http::KEEP_ALIVE;
	...
	const std::string &expected_request_buffer = "GET / HTTP/1.1\r\nHost: localhost\r\nConnection: keep-alive\r\n\r\n";
	http::HttpResult expected = CreateHttpResult(true, true, expected_request_buffer, expected_response1);
...
int TestGetOk5ConnectionCloseAndOkConnectionClose(const server::VirtualServerAddrList &server_infos) {
	http::ClientInfos client_infos         = CreateClientInfos(request::GET_200_5_CONNECTION_CLOSE_AND_200_CONNECTION_CLOSE);
	std::string       expected_status_line = EXPECTED_STATUS_LINE_OK;
	std::string       expected_body_message = LoadFileContent("../../../../root/html/index.html");
	HeaderFields      expected_header_fields;
	expected_header_fields[http::CONNECTION]     = http::CLOSE;
	...
	const std::string &expected_request_buffer = "GET / HTTP/1.1\r\nHost: localhost\r\nConnection: close\r\n\r\n";
	http::HttpResult expected = CreateHttpResult(true, false, expected_request_buffer, expected_response1);
...
int TestGetOk6ConnectionKeepAndOkConnectionClose(const server::VirtualServerAddrList &server_infos) {
	http::ClientInfos client_infos         = CreateClientInfos(request::GET_200_6_CONNECTION_CLOSE_AND_200_CONNECTION_CLOSE);
	std::string       expected_status_line = EXPECTED_STATUS_LINE_OK;
	std::string       expected_body_message = LoadFileContent("../../../../root/html/index.html");
	HeaderFields      expected_header_fields;
	expected_header_fields[http::CONNECTION]     = http::KEEP_ALIVE;
...
int TestGetOk7DuplicateConnectionKeep(const server::VirtualServerAddrList &server_infos) {
	http::ClientInfos client_infos         = CreateClientInfos(request::GET_200_7_DUPLICATE_CONNECTION_KEEP);
	std::string       expected_status_line = EXPECTED_STATUS_LINE_OK;
	std::string       expected_body_message = LoadFileContent("../../../../root/html/index.html");
	HeaderFields      expected_header_fields;
	expected_header_fields[http::CONNECTION]     = http::KEEP_ALIVE;
...
int TestGetOk8DuplicateConnectionClose(const server::VirtualServerAddrList &server_infos) {
	http::ClientInfos client_infos         = CreateClientInfos(request::GET_200_8_DUPLICATE_CONNECTION_CLOSE);
	std::string       expected_status_line = EXPECTED_STATUS_LINE_OK;
	std::string       expected_body_message = LoadFileContent("../../../../root/html/index.html");
	HeaderFields      expected_header_fields;
	expected_header_fields[http::CONNECTION]     = http::CLOSE;
...
int TestGetOk9ConnectionKeepAndClose(const server::VirtualServerAddrList &server_infos) {
	http::ClientInfos client_infos         = CreateClientInfos(request::GET_200_9_CONNECTION_KEEP_AND_CLOSE);
	std::string       expected_status_line = EXPECTED_STATUS_LINE_OK;
	std::string       expected_body_message = LoadFileContent("../../../../root/html/index.html");
	HeaderFields      expected_header_fields;
	expected_header_fields[http::CONNECTION]     = http::CLOSE;
...
int TestGetOk10ConnectionCloseAndKeep(const server::VirtualServerAddrList &server_infos) {
	http::ClientInfos client_infos         = CreateClientInfos(request::GET_200_10_CONNECTION_CLOSE_AND_KEEP);
	std::string       expected_status_line = EXPECTED_STATUS_LINE_OK;
	std::string       expected_body_message = LoadFileContent("../../../../root/html/index.html");
	HeaderFields      expected_header_fields;
	expected_header_fields[http::CONNECTION]     = http::CLOSE;
